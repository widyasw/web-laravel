...
<head>
  ...
  <title>Beauty Me | Dashboard</title>
...
<div class="wrapper">
      ...
      <div class="content-wrapper">
        <div class="content-header">
            <?php if(session()->has('message')): ?>
                <div class="alert alert-<?php echo e(session()->get('alert')); ?> alert-dismissible">
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2023 <a href="https://adminlte.io">Beauty Me</a>.</strong>
    All rights reserved.
...
<?php /**PATH C:\xampp\htdocs\skincare-store\resources\views/layouts/admin.blade.php ENDPATH**/ ?>