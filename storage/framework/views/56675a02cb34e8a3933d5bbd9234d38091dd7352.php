        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?php echo e(route('admin.properties.create')); ?>" class="btn btn-primary shadow-sm">Add</a></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                  ...
                  <tbody>
                    <?php $__currentLoopData = $properties; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $property): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo e(route('admin.properties.edit',$property->id)); ?>" class="btn btn-info">edit</a>
                                <form onclick="return confirm('are you sure ?');" class="d-inline-block" action="<?php echo e(route('admin.properties.destroy', $property->id)); ?>" method="post">
                                    <?php echo csrf_field(); ?> 
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\skincare-store\resources\views/admin/properties/index.blade.php ENDPATH**/ ?>