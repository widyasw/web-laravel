        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
             <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?php echo e(route('admin.categories.create')); ?>" class="btn btn-primary shadow-sm">Add</a></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                  ...
                  <tbody>
                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td>
                                <a target="_blank" href="<?php echo e(Storage::url($category->banner)); ?>">
                                    <img src="<?php echo e(Storage::url($category->banner)); ?>" width="100" alt="">
                                </a>
                            </td>
                            <td>
                                <a href="<?php echo e(route('admin.categories.edit',$category->id)); ?>" class="btn btn-info">edit</a>
                                <form onclick="return confirm('are you sure ?');" class="d-inline-block" action="<?php echo e(route('admin.categories.destroy', $category->id)); ?>" method="post">
                                    <?php echo csrf_field(); ?> 
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\skincare-store\resources\views/admin/categories/index.blade.php ENDPATH**/ ?>